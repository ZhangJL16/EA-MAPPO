...
class UAVEnv:
    ...
    def _charge_slot_target(self, agent, charge_rank):
        ...
        target = self.charging_station_pos + offset
    ...
    def _charge_agents_at_station(self):
        candidates = [
            agent
            for agent in self.agents
            if self._agent_ready_to_charge(agent)
