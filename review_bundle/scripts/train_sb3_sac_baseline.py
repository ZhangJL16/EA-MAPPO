...
def make_environment(args: argparse.Namespace, *, max_episode_steps: int | None = None) -> NavigationEnv:
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Formal 1M pinned-SB3 SAC navigation baseline")
