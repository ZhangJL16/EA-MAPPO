#!/usr/bin/env python3
"""Frozen v2 evaluation on immutable five-distance tasks; resumable batch rows."""
...
def main() -> None:
    ...
    if training["observation_dim"] != DIM or metadata["transitions"] != settings["target_steps"]:
        raise ValueError("requires the completed v2 checkpoint")
    ...
    contract = {
        "protocol": "deployable_v2_fixed500_v1", "formal": not args.smoke,
