...
# HSD-style runnable baseline: generic hierarchical subgoal learning without
# the proposed energy-aware shield/loss, charge-resource queue, auction module,
# or safety guard.
...
append_default_arg DEFAULT_ARGS --hrl_use_intrinsic_reward True "${USER_ARGS[@]}"
...
append_default_arg DEFAULT_ARGS --hrl_auction_enabled False "${USER_ARGS[@]}"
