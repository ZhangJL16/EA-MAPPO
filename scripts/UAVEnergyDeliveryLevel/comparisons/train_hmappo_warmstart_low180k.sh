...
append_default_arg DEFAULT_ARGS --hrl_energy_margin_reserve_ratio 0.08 "${USER_ARGS[@]}"
append_default_arg DEFAULT_ARGS --hrl_energy_margin_loss_coef 0.2 "${USER_ARGS[@]}"
