...
append_default_arg DEFAULT_ARGS --hrl_fixed_charge_threshold_enabled True "${USER_ARGS[@]}"
append_default_arg DEFAULT_ARGS --hrl_fixed_charge_threshold 0.35 "${USER_ARGS[@]}"
append_default_arg DEFAULT_ARGS --hrl_fixed_charge_release_threshold 0.65 "${USER_ARGS[@]}"
