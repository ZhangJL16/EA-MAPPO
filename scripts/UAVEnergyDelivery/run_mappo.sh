...
usage() {
  cat <<'EOF'
Usage:
  ./scripts/UAVEnergyDelivery/run_mappo.sh [main.py args...]

Examples:
  ./scripts/UAVEnergyDelivery/run_mappo.sh
  ./scripts/UAVEnergyDelivery/run_mappo.sh --gpu_id 1 --n_steps 600000
  EXPERIMENT_DEVICE=lab RUN_DIR=logs/my_energy_run ./scripts/UAVEnergyDelivery/run_mappo.sh
