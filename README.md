...
- [二维 PPO v3 固定时窗修复后的完整 seed 101 失败诊断](MODE_PPO_V3_GAMMA1_RESULT_20260926.md)
...
- [冻结 PPO 站内充电失效与隔离诊断](PPO_DOCK_STALL_DIAGNOSTIC_20260926.md)
- [站内充电干预 24 作业完整配对结果](PPO_DOCK_SUPERVISION_RESULT_20260926.md)
