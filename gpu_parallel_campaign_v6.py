...
SECONDS = 8 * 60 * 60
DEFAULT_OUTPUT = ROOT / 'artifacts/gpu_mpc_parallel_v6_8workers_20260926'
GIB = 1024 ** 3
...
def seed_from(output: Path, source: Path) -> dict:
    ...
    result = {'protocol': 'gpu_mpc_parallel_seed_v6',
...
def expected_manifest(workers: int) -> dict:
    return {
        'protocol': 'gpu_mpc_parallel_campaign_v6_8workers',
